...
<div class="flex items-start justify-between mb-8">
    <div class="flex-1">
        <h1 class="mb-2 text-3xl font-bold leading-tight text-gray-900">Add New Supplier</h1>
        <p class="text-base font-normal text-gray-600">Fill in the details below to add a new supplier to your list</p>
    </div>
